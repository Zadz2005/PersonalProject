    ...
    async function handleSaveNote() {
        ...
        try {
            ...
            if (note.id) {
                ...
                const noteRef = doc(
AINotes, 'users', currentUser.uid, 'notes', note.id)
                ...
                const notesRef = doc(
AINotes, 'users', currentUser.uid, 'notes', newId)
    ...
    useEffect(() => {
        ...
        async function fetchNote() {
            ...
            try {
                ...
                const noteRef = doc(
AINotes, 'users', currentUser.uid, 'notes', value)
